...
/*******************************************/
/*  The following section of code is for   */
...
/*  fit several models and look at   */
/*  variance inflation factors       */
title ' ';
proc reg data=fat plots=diagnostics;
 model bodyfat = midarm;               
 model bodyfat = thigh;                
 model bodyfat = triceps;              
 model bodyfat = midarm triceps / vif; 
 model bodyfat = midarm thigh / vif;   
 run;
